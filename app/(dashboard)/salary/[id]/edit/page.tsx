...
export default function EditSalaryPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setEffectiveFrom(data.effectiveFrom?.toDate ? formatDate(data.effectiveFrom.toDate()) : "")
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <Button type="button" variant="outline" nativeButton={false} render={<Link href="/salary" />}>
                Cancel
              </Button>
            </div>
          </form>
